...
const Header = ({showSidebar, setShowSidebar}) => {
    ...
    return (
        <div className='fixed top-0 left-0 w-full py-5 px-2 lg:px-7 z-40'>
            <div className='ml-0 lg:ml-[260px] rounded-md h-[65px] flex justify-between items-center bg-[#bdbddf] px-5 transition-all'>
            ...
            <div className='hidden md:block'>
                <input type="text" name="search" placeholder='search' className='px-3 py-2 outline-none border bg-transparent border-slate-700 rounded-md text-[#423d72] focus:border-indigo-300 overflow-hidden' />
                ...
                <div className='flex justify-center items-center'>
                    <div className='flex justify-center items-center gap-3'>
                        <div className='flex justify-center items-center flex-col text-end'>
                            ...
                            <span className='text-sm w-full font-normal'>{ userInfo.role }</span>
                        </div>
                        {
