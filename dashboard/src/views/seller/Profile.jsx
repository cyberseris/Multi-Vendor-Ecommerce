...
const Profile = () => {
    ...
    const add_image = (e) => {
        if(e.target.files.length > 0){
            console.log("add_image: ", e.target.files[0])
                        ...
                        <div className='px-0 md:px-5 py-2'>
                            {
                                !userInfo?.shopInfo ? <form onSubmit={add}>
                                    <div className='flex flex-col w-full gap-1 mb-2'> 
                                        ...
                                        <input value={state.shopName} onChange={inputHandler} className='px-4 py-2 bg-[#6a5fdf] focus:border-indigo-500/50 outline-none border border-slate-700 rounded-md text-[#d0d2d6]' type="text" name='shopName' id='shopName' placeholder='Shop Name'  />
                                    </div>
                                    <div className='flex flex-col w-full gap-1 mb-2'> 
                                        <label htmlFor="division">Division Name</label>
                                        <input value={state.division} onChange={inputHandler} className='px-4 py-2 bg-[#6a5fdf] focus:border-indigo-500/50 outline-none border border-slate-700 rounded-md text-[#d0d2d6]' type="text" name='division' id='division' placeholder='Division Name'  />
                                    </div>
                                    <div className='flex flex-col w-full gap-1 mb-2'> 
                                        <label htmlFor="district">District Name</label>
                                        <input value={state.district} onChange={inputHandler} className='px-4 py-2 bg-[#6a5fdf] focus:border-indigo-500/50 outline-none border border-slate-700 rounded-md text-[#d0d2d6]' type="text" name='district' id='district' placeholder='District Name' />
                                    </div>
                                    <div className='flex flex-col w-full gap-1 mb-2'> 
                                        <label htmlFor="subdis">Sub District Name</label>
                                        <input value={state.sub_district} onChange={inputHandler} className='px-4 py-2 bg-[#6a5fdf] focus:border-indigo-500/50 outline-none border border-slate-700 rounded-md text-[#d0d2d6]' type="text" name='sub_district' id='subdis' placeholder='Sub District Name'  />
                                    </div>
