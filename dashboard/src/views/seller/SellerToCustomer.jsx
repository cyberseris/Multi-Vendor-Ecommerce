...
import { get_customers, get_customer_message, send_message, updateMessage, messageClear } from '../../store/Reducers/chatReducer'
...
const SellerToCustomer = () => {
    ...
    useEffect(()=>{
        console.log("get_customers: ", userInfo._id)
                ...
                <div className='flex w-full h-full relative'>
                    <div className={`w-[280px] h-full absolute z-10 ${show?'-left-[16px]':'-left-[336px]'} md:left-0 md:relative transition-all`}>
                        <div className='w-full h-[calc(100vh-177px)] bg-[#9e97e9] md:bg-transparent overflow-y-auto'>
                            ...
                            {
                                customers && customers.map((c,i)=> <Link key={i} to={`/seller/dashboard/chat-customer/${c.fdId}`} className={`h-[60px] flex justify-start items-center gap-2 text-white px-2 py-2 rounded-md cursor-pointer bg-[#8288ed]`}>
                                <div className='relative'>
                                    <img className='w-[38px] h-[38px] border-white border-2 max-w-[38px] p-[2px] rounded-full' src={c.image ? c.image: 'http://localhost:3001/images/admin.jpg'} alt="" />
                    ...
                    <div className='w-full md:w-[calc(100%-200px)] md:pl-4'>
                        ...
                        <form onSubmit={send} className='flex gap-3'>
                            ...
                            <button className='w-[75px] h-[35px] shadow-lg bg-[#06b6d4] hover:shadow-cyan-500/50 text-semibold rounded-md text-white justify-center items-center'>Send</button>
