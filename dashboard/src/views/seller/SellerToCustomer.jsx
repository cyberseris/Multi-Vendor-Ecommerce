                ...
                <div className='flex w-full h-full relative'>
                    <div className={`w-[280px] h-full absolute z-10 ${show?'-left-[16px]':'-left-[336px]'} md:left-0 md:relative transition-all`}>
                        <div className='w-full h-[calc(100vh-177px)] bg-[#9e97e9] md:bg-transparent overflow-y-auto'>
                            ...
                            <div className={`h-[60px] flex justify-start items-center gap-2 text-white px-2 py-2 rounded-md cursor-pointer bg-[#8288ed]`}>
                                ...
                                <div className='flex justify-center items-start flex-col w-full'>
                                    <div className='flex justify-between items-center w-full'>
                                        <h2 className='text-base font-semibold'>Seris</h2>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className={`h-[60px] flex justify-start items-center gap-2 text-white px-2 py-2 rounded-sm cursor-pointer`}>
                                ...
                                <h2 className='text-base text-white font-semibold'>Seris</h2>
                        ...
                        <div className='flex justify-between items-center'>
                            {
                                sellerId && <div className='flex justify-start items-center gap-3'>
                                    <div className='relative'>
                                        <img className='w-[45px] h-[45px] border-green-500 border-2 max-w-[45px] p-[2px] rounded-full' src="http://localhost:3000/images/admin.jpg" alt="" />
                                        <div className='w-[10px] h-[10px] bg-green-500 rounded-full absolute right-0 bottom-0'>
                                        </div>
                                    </div>  
                                </div>
