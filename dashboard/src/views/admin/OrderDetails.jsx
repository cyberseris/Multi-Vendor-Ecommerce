        ...
        <div className='px-2 lg:px-7 pt-5'>
            <div className='w-full p-4 bg-[#6a5fdf] rounded-md'>
                <div className='flex justify-between items-center p-4'>
                    ...
                    <select onChange={status_update} value={status} className='px-4 py-2 focus:border-indigo-500 outline-none bg-[#475569] border border-slate-700 rounded-md text-[#d0d2d6]' name="" id="">
                        ...
                        <div className='w-[70%]'>
                            <div className='pl-3'>
                                <div className='mt-4 flex flex-col bg-[#8288ed] rounded-md p-4'>
                                    {
                                        order?.suborder?.map((sub_o,i)=><div key={i} className='text-[#d0d2d6] mt-2'>
                                        <div className='flex justify-start items-center gap-3'>
                                            <h2>Seller { i+1 } Order: </h2>
                                            <span>{sub_o.delivery_status}</span>
                                        </div>

                                        {
                                            sub_o?.products.map((p, i) => <div key={i} className='flex gap-3 text-md mt-2'>
                                            <img className='w-[50px] h-[50px] rounded-full' src={p.images[0]} alt="" />
