                        ...
                        <tbody>
                            {
                                ...
                                <td className='py-2 px-4 text-center font-medium whitespace-nowrap'>{d.payment}</td>
                                <td className='py-2 px-4 text-center font-medium whitespace-nowrap'>{d.status}</td>
