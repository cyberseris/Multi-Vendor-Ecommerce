...
const OrderDetails = () => {
    ...
    return (
        <div className='bg-white p-5'>
            <h2 className='text-slate-600 font-semibold text-sm'>#{myOrder._id} <span className='pl-1'>{myOrder.date}</span></h2>
            <div className='grid grid-cols-2 gap-3 '>
                ...
                <div className='text-slate-600'>
                    <h2 className='font-mono'>Price: ${myOrder.price}</h2>
                        ...
                        myOrder.products?.map((p,i)=><div key={i}>
                            <div className='flex gap-5 justify-start items-center text-slate-600'>
                                ...
                                <div className='pl-4 flex flex-col'>
                                    <h2 className='text-md text-green-800'>${p.price - p.discount}</h2>
