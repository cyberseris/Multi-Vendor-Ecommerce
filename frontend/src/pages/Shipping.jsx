...
import { quantity_dec, place_order } from './../store/reducers/orderReducer';

const Shipping = () => {
    // 使用 useLocation() 傳遞臨時資料
    // 重新整理頁面後資料會消失。
    // 適合一次性導向，如「立即結帳」、「預覽商品」。
                                    ...
                                    <div className='bg-white p-6 shadow-sm rounded-md'>
                                        <h2 className='text-slate-600 font-bold pb-3'>Shipping Information</h2>
                                        {
                                            ...
                                            <div className='flex md:flex-col md:gap-2 w-full gap-5 text-slate-600'>
                                                ...
                                                <div className='flex flex-col gap-1 mb-2 mt-7 w-full'>
                                                    <button className="px-3 py-[6px] rounded-sm bg-green-500 hover:shadow-green-500/50 hover:shadow-lg text-white">Save Change</button>
                                                </div>
                                            </div>
                                                </form>
                                            </>
                                                ...
                                                p.products.map((pt,j)=><div key={j} className="w-full flex flex-wrap">
                                                    ...
                                                    <div className="flex justify-between w-5/12 sm:w-full sm:mt-3">
                                                        <div className="pl-4 sm:pl-0">
                                                            <h2 className="text-lg text-orange-500">${pt.productInfo.price-pt.productInfo.discount}</h2>
