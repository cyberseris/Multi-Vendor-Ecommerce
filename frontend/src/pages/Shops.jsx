...
/*     const [perPage, setPerPage] = useState(1); */
    ...
    const { products, totalProducts, perPage, categorys, priceRange, latest_product } = useSelector(state=>state.home) 
                    ...
                    <div className='w-[85%] sm:w-[90%] md:w-[80%] lg:w-[90%] h-full mx-auto'>
                        ...
                        <div className='w-full flex flex-wrap'>
                            <div className={`w-3/12 md-lg:w-4/12 md:w-full pr-8 ${filter ? 'md:h-0 md:overflow-hidden md:mb-6':'md:h-auto md:overflow-auto md:mb-0'}`}>
                                ...
                                <div className='py-2'>
                                    {
                                        categorys.map((c,i) => <div key={i} className='flex justify-start item-center gap-2 py-1'>
                                ...
                                <div className='py-2 flex flex-col gap-5'>
                                    ...
                                    {
                                        priceRange.low !== undefined && priceRange.low !== priceRange.high && state.values[0] !== 0 && <Range
                                            step={5}
                                            min={priceRange.low}
                                            max={priceRange.high}
                                            values={(state.values)}
                                    ...
                                    <span className='text-slate-800'>${ Math.floor(state.values[0])}-${Math.floor(state.values[1])}</span>

                                </div>
                            
                                <div className='py-3 flex flex-col gap-4'>
                                    <h2 className='text-3xl font-bold mb-3'>Ratings</h2>
                                    <div className='flex flex-col gap-3'>
                                        <div onClick={()=>setRating(5)} className='text-orange-500 flex justify-start items-center gap-2 text-xl cursor-pointer'>
                                        ...
                                        <div onClick={()=>setRating(4)} className='text-orange-500 flex justify-start items-center gap-2 text-xl cursor-pointer'>
                                            <span><AiFillStar /></span>
                                            <span><AiFillStar /></span>
                                            <span><AiFillStar /></span>
                                            <span><AiFillStar /></span>
                                        ...
                                        <div onClick={()=>setRating(3)} className='text-orange-500 flex justify-start items-center gap-2 text-xl cursor-pointer'>
                                            <span><AiFillStar /></span>
                                            <span><AiFillStar /></span>
                                            <span><AiFillStar /></span>
                                            <span><CiStar /></span>
                                        ...
                                        <div onClick={()=>setRating(2)} className='text-orange-500 flex justify-start items-center gap-2 text-xl cursor-pointer'>
                                            <span><AiFillStar /></span>
                                            <span><AiFillStar /></span>
                                            <span><CiStar /></span>
                                            <span><CiStar /></span>
                                        ...
                                        <div onClick={()=>setRating(1)} className='text-orange-500 flex justify-start items-center gap-2 text-xl cursor-pointer'>
                                            <span><AiFillStar /></span>
                                            <span><CiStar /></span>
                                            <span><CiStar /></span>
                                            <span><CiStar /></span>
                                        ...
                                        <div onClick={resetRating} className='text-orange-500 flex justify-start items-center gap-2 text-xl cursor-pointer'>
                                            <span><CiStar /></span>
                                            <span><CiStar /></span>
                                            <span><CiStar /></span>
                                            <span><CiStar /></span>
                                ...
                                <div className='pl-8 md:pl-0'>
                                    <div className='py-4 bg-white mb-10 px-3 rounded-md flex justify-between items-start border'>
                                        ...
                                        <div className='flex justify-center items-center gap-3'>
                                            <select onChange={(e)=>setSortPrice(e.target.value)} className='p-1 border outline-0 bg-white text-slate-600 font-semibold' name="" id="">
                                    ...
                                    <div>
                                        {
                                            totalProducts? perPage && <Pagination pageNumber={pageNumber} setPageNumber={setPageNumber} totalItem={totalProducts} perPage={perPage} showItem={Math.floor(totalProducts/perPage)} />:''
                                        }
                                    </div>
