...
router.get('/payment/get-payment-request', authMiddleware, paymentController.get_payment_request);

router.post('/payment/confirm-payment-request', authMiddleware, paymentController.confirm_payment_request);
